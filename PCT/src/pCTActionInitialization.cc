...
//
//
/// \file pCTActionInitialization.cc
/// \brief Implementation of the pCTActionInitialization class
...
{
  pCTRunAction* runAction = new pCTRunAction;
...
void pCTActionInitialization::Build() const
{
  ...
  pCTEventAction* eventAction = new pCTEventAction(runAction);
  SetUserAction(eventAction);
  
  SetUserAction(new pCTSteppingAction(eventAction));
}  
