...
void pCTXML::SetInputs(){
    ...
    if(myfile.is_open()){    
        ...
        XML2Int     ("AstraNBars",fAstraNBars);
        XML2Int     ("AstraNLayers",fAstraNLayers);
        XML2Double  ("AstraBarX",fAstraBarX);  
        XML2Double  ("AstraBarY",fAstraBarY);
        XML2Double  ("AstraBarZ",fAstraBarZ);
        XML2Double  ("BarCoatThick",fBarCoat);
        XML2Double  ("AstraX",fAstraX);
        XML2Double  ("AstraY",fAstraY);
